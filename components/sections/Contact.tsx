...
export default function Contact() {
  return (
    <AnimatedSection
      id="contact"
      className="px-16 py-32 grid grid-cols-2 gap-24 items-end"
    >
      {/* Left */}
      <div>
        ...
        <a
          ...
          className="font-serif text-xl italic text-accent border-b border-accent/30
        ...
        {siteConfig.socials.map((social) => (
          <a
            ...
            className="flex items-center gap-4 font-mono text-[0.72rem] tracking-widest uppercase
                       text-muted transition-colors duration-300 hover:text-ink group hoverable
